...
if (GVAR(log)) then {
    LOG_2("Present HCs: %1 - Full Rebalance: %2",GVAR(headlessClients),_force);
};
...
if (GVAR(log)) then {
    ...
    LOG_4("Groups Transferred: Total: %1 - HC1: %2 - HC2: %3 - HC3: %4", _numTransferredTotal, _numTransferredHC1, _numTransferredHC2, _numTransferredHC3);
};
