 ...
 *
 *  Description:
 *      execution of the evade state - group moves to a position by evadeing enemys
 *
 *  Parameter(s):
...
[_group, _lastWaypoint, 25, "MOVE", "COMBAT", "YELLOW", "FULL", "NO CHANGE", _statement, [3,6,9], 30] call FUNC(waypoints_add);
