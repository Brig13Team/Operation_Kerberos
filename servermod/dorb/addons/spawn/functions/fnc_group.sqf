...
private _group = switch (getNumber(configFile >> "CfgVehicles" >> (_types select 0) >> "side")) do {
...

{
    ...
    If (_isMan) then {
        ...
        _unit = ([_spawnpos,_group,_x,random(360),true,false,"NONE"] call FUNC(vehicle)) select 1;
    };
