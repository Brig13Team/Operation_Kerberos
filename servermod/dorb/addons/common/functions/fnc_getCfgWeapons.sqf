...
private _value = GVAR(cfgWeaponCacheLocal) getVariable _valueName;
...
If (isNumber _cfg) then {
    ...
    GVAR(cfgWeaponCacheLocal) setVariable [_valueName, _value];
    _value
};
...
GVAR(cfgWeaponCacheLocal) setVariable [_valueName, _default];
