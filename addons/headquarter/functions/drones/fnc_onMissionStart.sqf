...
GVAR(drones_attackIntervall) = If (GVARMAIN(side_type)=="droneoperations") then {400} else {600};
GVAR(drones_reconIntervall) = If (GVARMAIN(side_type)=="droneoperations") then {400} else {600};
