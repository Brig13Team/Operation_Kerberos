...
if (!isText(ConfigFile >> "CfgKerberos" >> "headquarter" >> "drones" >> typeOf _drone >> "muzzle")) exitWith { _drone call _onExit; false };
_wp_type = getText (ConfigFile >> "CfgKerberos" >> "headquarter" >> "drones" >> typeOf _drone >> "attack_waypoint");
