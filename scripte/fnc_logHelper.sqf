...
DORB_HELPER_ARROW = [createVehicle ["Sign_Arrow_F", [0,0,0], [], 0, "CAN_COLLIDE"],createVehicle ["Sign_Arrow_Green_F", [0,0,0], [], 0, "CAN_COLLIDE"] ];
...
DORB_HELPER_ID = [{
    ...
    _pos = DORB_HELPER_VEH modelToWorld DORB_HELPER_POS2;
