...
GVAR(spawnlist_west) = HASH_CREATE;

{
    HASH_SET(GVAR(spawnlist_west),(_x select 0),(_x select 1));
} forEach [
    ["vehicles",_fahrzeugliste],
    ["drones",_drohnenliste],
    ["air",_luftliste_CAS],
    ["air_light",_luftliste_log],
    ["boat",_marineliste],
    ["logistic",_logistikliste]
];
