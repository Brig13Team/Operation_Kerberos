...
[
    "KnockKnock",
    {
        ...
        [_tank,_knocker] say3D [QGVARMAIN(sound_knockknock),20,1];
    }
...
private _Action = [QGVAR(action_knockknock), localize LSTRING(ACTION_KNOCKKNOCK), "", {["KnockKnock",[_target,player]] call FUNC(clientEvent);}, {alive _target}] call ace_interact_menu_fnc_createAction;
