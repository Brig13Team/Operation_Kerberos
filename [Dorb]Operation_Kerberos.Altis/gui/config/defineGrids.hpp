...
#define GUI_LOADINGBAR_Y (safezoneY + safezoneH - 10 * GUI_GRID_H)
#define GUI_LOADINGBAR_H (3 * GUI_GRID_H)
#define GUI_LOADINGBAR_W (11 * GUI_GRID_W)
#define GUI_LOADINGBAR_STATE_X (safezoneX + 0.5 * GUI_GRID_W)
#define GUI_LOADINGBAR_STATE_Y (safezoneY + safezoneH - 10 * GUI_GRID_H)
#define GUI_LOADINGBAR_STATE_H (GUI_GRID_H)
#define GUI_LOADINGBAR_STATE_W (2 * GUI_GRID_W)
#define GUI_LOADINGBAR_ARROW_X (safezoneX + 0.75 * GUI_GRID_W)
#define GUI_LOADINGBAR_ARROW_Y (safezoneY + safezoneH - 9 * GUI_GRID_H)
#define GUI_LOADINGBAR_ARROW_H (0.5 * GUI_GRID_H)
#define GUI_LOADINGBAR_ARROW_W (0.5 * GUI_GRID_W)
#define GUI_LOADINGBAR_BAR_X (safezoneX + 1 * GUI_GRID_W)
#define GUI_LOADINGBAR_BAR_Y (safezoneY + safezoneH - 8.5 * GUI_GRID_H)
#define GUI_LOADINGBAR_BAR_H (1 * GUI_GRID_H)
#define GUI_LOADINGBAR_BAR_W (10 * GUI_GRID_W)
#define GUI_LOADINGBAR_HEADER_X (safezoneX + 0.5 * GUI_GRID_W)
#define GUI_LOADINGBAR_HEADER_Y (safezoneY + safezoneH - 7 * GUI_GRID_H)
#define GUI_LOADINGBAR_HEADER_H (GUI_GRID_H)
