...
/// Roadarray
_roads_formatted = [_position,_radius] call FUNC(city_roads);
...
[_roads_formatted,true,_fortifications,_ieds,_civvehicles,false] call FUNC(city_fortify_roads);

// Buildings 

[_buildings_formatted,_optionarray]call FUNC(city_fortify_buildings);
