...
EGVAR(ai,hq_callIn_cas) = getNumber(_path >> "callIn" >> "cas");
EGVAR(ai,hq_callIn_motorized) = getNumber(_path >> "callIn" >> "motorized");
EGVAR(ai,hq_callIn_armored) = getNumber(_path >> "callIn" >> "armored");
