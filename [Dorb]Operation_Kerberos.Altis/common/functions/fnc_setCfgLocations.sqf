...
EGVAR(mission,locations) = HASH_CREATE;
HASH_SET(EGVAR(mission,locations),"city",_loc_civ);
HASH_SET(EGVAR(mission,locations),"industrie",_loc_ind);
HASH_SET(EGVAR(mission,locations),"military",_loc_mil);
HASH_SET(EGVAR(mission,locations),"water",_loc_water);
HASH_SET(EGVAR(mission,locations),"other",_loc_sonst);
