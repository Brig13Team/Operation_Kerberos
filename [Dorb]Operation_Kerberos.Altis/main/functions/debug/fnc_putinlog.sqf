...
if (!(_file isEqualTo "")) then {
	...
	[format["[%1_%2_%3:%4]-%5 (%6:%7) %8",_addon,_part,_file,_line,_time,diag_tickTime,diag_frameNo,_header]] call FUNC(debug_write);
}else{
	[format["[%1_%2]-%3 (%4:%5) %6",_addon,_part,_time,diag_tickTime,diag_frameNo,_header]] call FUNC(debug_write);
};
