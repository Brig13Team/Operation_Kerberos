...
Author:
    ...
    Dorbedo
------------------------------------------- */
#define LOG(STRING) ["LOG", _fnc_scriptname ,if (isNil "_fnc_scriptNameParent") then {""}else{_fnc_scriptNameParent},STRING,__FILE__, __LINE__] call EFUNC(main,debug_putinlog)
/* -------------------------------------------
Macro: LOG_n(VAR)
...
#define WARNING(VAR) ["WARNING",_fnc_scriptname,if (isNil "_fnc_scriptNameParent") then {""}else{_fnc_scriptNameParent},VAR,__FILE__, __LINE__] call EFUNC(main,debug_putinlog)
#define DEBUG_MODE_MINIMAL
...
#define ERROR(VAR) ["ERROR", _fnc_scriptname ,if (isNil "_fnc_scriptNameParent") then {""}else{_fnc_scriptNameParent},VAR,__FILE__, __LINE__] call EFUNC(main,debug_putinlog)
