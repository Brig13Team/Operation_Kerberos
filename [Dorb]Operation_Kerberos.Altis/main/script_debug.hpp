...
------------------------------------------- */
    ...
    #define LOG(VAR) [QUOTE(ADDON),QUOTE(PART),VAR,THIS_FILE_, __LINE__] call EFUNC(main,debug_putinlog)
    ...
    #define CHECK(CONDITION) if (CONDITION) exitWith {LOG("CHECK-FAILED");};
	
	#define WARNING(VAR) [QUOTE(ADDON),QUOTE(PART),VAR,THIS_FILE_, __LINE__] call EFUNC(main,debug_putinlog)
#else
    ...
    #define ERROR(VAR) [QUOTE(ADDON),QUOTE(PART),VAR,THIS_FILE_, __LINE__] call EFUNC(main,debug_putinlog)
#else
