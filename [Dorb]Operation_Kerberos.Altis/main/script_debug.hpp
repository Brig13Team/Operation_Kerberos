...
------------------------------------------- */
	...
	#define TRACE_1(MESSAGE,A) [QUOTE(ADDON),QUOTE(PART),PFORMAT_1(MESSAGE,A),THIS_FILE_, __LINE__] call FUNCMAIN(debug_putinlog)
	#define TRACE_2(MESSAGE,A,B) [QUOTE(ADDON),QUOTE(PART),PFORMAT_2(MESSAGE,A,B),THIS_FILE_, __LINE__] call FUNCMAIN(debug_putinlog)
	#define TRACE_3(MESSAGE,A,B,C) [QUOTE(ADDON),QUOTE(PART),PFORMAT_3(MESSAGE,A,B,C),THIS_FILE_, __LINE__] call FUNCMAIN(debug_putinlog)
	#define TRACE_4(MESSAGE,A,B,C,D) [QUOTE(ADDON),QUOTE(PART),PFORMAT_4(MESSAGE,A,B,C,D),THIS_FILE_, __LINE__] call FUNCMAIN(debug_putinlog)
	#define TRACE_5(MESSAGE,A,B,C,D,E) [QUOTE(ADDON),QUOTE(PART),PFORMAT_5(MESSAGE,A,B,C,D,E),THIS_FILE_, __LINE__] call FUNCMAIN(debug_putinlog)
	#define TRACE_6(MESSAGE,A,B,C,D,E,F) [QUOTE(ADDON),QUOTE(PART),PFORMAT_6(MESSAGE,A,B,C,D,E,F),THIS_FILE_, __LINE__] call FUNCMAIN(debug_putinlog)
	#define TRACE_7(MESSAGE,A,B,C,D,E,F,G) [QUOTE(ADDON),QUOTE(PART),PFORMAT_7(MESSAGE,A,B,C,D,E,F,G),THIS_FILE_, __LINE__] call FUNCMAIN(debug_putinlog)
	#define TRACE_8(MESSAGE,A,B,C,D,E,F,G,H) [QUOTE(ADDON),QUOTE(PART),PFORMAT_8(MESSAGE,A,B,C,D,E,F,G,H),THIS_FILE_, __LINE__] call FUNCMAIN(debug_putinlog)
	#define TRACE_9(MESSAGE,A,B,C,D,E,F,G,H,I) [QUOTE(ADDON),QUOTE(PART),PFORMAT_9(MESSAGE,A,B,C,D,E,F,G,H,I),THIS_FILE_, __LINE__] call FUNCMAIN(debug_putinlog)
    ...
    #define LOG_2(VAR1,VAR2) LOG(FORMAT_4("%1=%2\n%3=%4",QUOTE(VAR1),RETNIL(VAR1),QUOTE(VAR2),VAR2))
