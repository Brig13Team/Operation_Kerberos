...
#define FORMAT_18(STR,ARG1,ARG2,ARG3,ARG4,ARG5,ARG6,ARG7,ARG8,ARG9,ARG10,ARG11,ARG12,ARG13,ARG14,ARG15,ARG16,ARG17,ARG18) format[STR, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7, ARG8, ARG9, ARG10, ARG11, ARG12, ARG13, ARG14, ARG15, ARG16, ARG17, ARG18]
    ...
    #define TRACE_SYS(STRING) ["TRACE",QUOTE(ADDON),QUOTE(PART),STRING,__FILE__, __LINE__] call EFUNC(main,debug_putinlog)
    ...
    #define TRACE_4(MESSAGE,A,B,C,D) ["TRACE",QUOTE(ADDON),QUOTE(PART),PFORMAT_4(MESSAGE,A,B,C,D),THIS_FILE_, __LINE__] call EFUNC(main,debug_putinlog)
    #define TRACE_5(MESSAGE,A,B,C,D,E) ["TRACE",QUOTE(ADDON),QUOTE(PART),PFORMAT_5(MESSAGE,A,B,C,D,E),THIS_FILE_, __LINE__] call EFUNC(main,debug_putinlog)
    #define TRACE_6(MESSAGE,A,B,C,D,E,F) ["TRACE",QUOTE(ADDON),QUOTE(PART),PFORMAT_6(MESSAGE,A,B,C,D,E,F),THIS_FILE_, __LINE__] call EFUNC(main,debug_putinlog)
    #define TRACE_7(MESSAGE,A,B,C,D,E,F,G) ["TRACE",QUOTE(ADDON),QUOTE(PART),PFORMAT_7(MESSAGE,A,B,C,D,E,F,G),THIS_FILE_, __LINE__] call EFUNC(main,debug_putinlog)
    #define TRACE_8(MESSAGE,A,B,C,D,E,F,G,H) ["TRACE",QUOTE(ADDON),QUOTE(PART),PFORMAT_8(MESSAGE,A,B,C,D,E,F,G,H),THIS_FILE_, __LINE__] call EFUNC(main,debug_putinlog)
    #define TRACE_9(MESSAGE,A,B,C,D,E,F,G,H,I) ["TRACE",QUOTE(ADDON),QUOTE(PART),PFORMAT_9(MESSAGE,A,B,C,D,E,F,G,H,I),THIS_FILE_, __LINE__] call EFUNC(main,debug_putinlog)
