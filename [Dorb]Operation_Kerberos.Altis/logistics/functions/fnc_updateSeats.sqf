...
private ["_cargo_positions","_cargo_point","_stack","_last_row","_y","_i"];
...
_cargo_positions = getArray (missionConfigFile >> "logistics" >> "vehicles" >> (typeOf _vehicle) >> "cargo_pos");
_cargo_point = getArray (missionConfigFile >> "logistics" >> "vehicles" >> (typeOf _vehicle) >> "cargo_point");
