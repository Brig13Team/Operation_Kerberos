...
[["<t size='1.5' shadow='2' color='#F9FE44'>" +localize LSTRING(TELEPORT) +"</t>", {createDialog QGVAR(teleporter);}, [], 5, false, true, "","alive _target and (getposatl player distance getposatl teleporter5) < 6"]] call CBA_fnc_addPlayerAction;