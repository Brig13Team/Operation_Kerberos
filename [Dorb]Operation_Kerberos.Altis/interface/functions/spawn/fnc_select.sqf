...
private _ctrlname = findDisplay dlg_veh_spawn_idd displayCtrl dlg_veh_spawn_vehname_idc;
private _ctrlpic = findDisplay dlg_veh_spawn_idd displayCtrl dlg_veh_spawn_pic_idc;
