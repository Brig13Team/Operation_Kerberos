class RscTitles {
  class dorb_interface_disp_msg {
    duration = 20;
    idd = 700100;
    movingenable = 0;
    onLoad = "uiNamespace setVariable ['dorb_interface_disp_msg', _this select 0];";
  ...
  class dorb_interface_disp_info {
	duration = 20;
	idd = 700106;
	movingenable = 0;
	onLoad = "uiNamespace setVariable ['dorb_interface_disp_info', _this select 0];";
    class controlsBackground {
      class dorb_disp_header : dorb_gui_backgroundBase {
        text = "";
        idc = 700109;
  ...
  class dorb_interface_disp_timer {
	duration = 61;
	idd = 700103;
	movingenable = 0;
	onLoad = "uiNamespace setVariable ['dorb_interface_disp_timer', _this select 0];";
	class controlsBackground {
      class dorb_disp_header : dorb_gui_backgroundBase {
        text = "";
        idc = 700104;
  ...
  class dorb_interface_disp_progressbar {
    duration = 1e+011;
    idd = 700105;
    movingenable = 0;
    onLoad = "uiNamespace setVariable ['dorb_interface_disp_progressbar', _this select 0];";
	class controls {
		class Progress {
			idc=6;
			type = 8;
