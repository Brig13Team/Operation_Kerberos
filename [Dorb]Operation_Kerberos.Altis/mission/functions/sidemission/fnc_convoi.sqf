...
[
    ...
    {},
    QUOTE({unassignVehicle (_x);_x allowDamage false;moveOut _x;uisleep 0.3;_x allowDamage true;}forEach (units (_this select 2));[_this select 1] call EFUNC(ai,register_Group);[_this select 2] call EFUNC(ai,register_Group);),
