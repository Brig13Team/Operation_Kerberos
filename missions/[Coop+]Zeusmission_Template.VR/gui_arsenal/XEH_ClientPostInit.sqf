...
switch (side player) do {
    case east : {
        [getmarkerpos "respawn_east"] call FUNC(addArsenalArea);
    };
    case resistance : {
        [getmarkerpos "respawn_guerilla"] call FUNC(addArsenalArea);
    };
    default {
        [getmarkerpos "respawn_west"] call FUNC(addArsenalArea);
    };
};
