...
private _daten = missionNamespace getVariable [QGVAR(crate_items),[]];
...
missionNamespace setVariable [QGVAR(crate_patches),_patches];
missionNamespace setVariable [QGVAR(crate_items),_daten];
