...
private _spawns = switch (side player) do {
    case resistance : {
        [["vehicles_resistance",    spawn_vehicles_guer,     "tank",     2],
        ["drones_resistance",      spawn_drones_guer,       "drone",    1],
        ["air_resistance",         spawn_air_guer,          "heli",     1],
        ["boat_resistance",        spawn_boat_guer,         "harbour",  2],
        ["logistic_resistance",    spawn_logistic_guer,     "logistic", 2]]
    };
    default {
