...
class dorb_veh_spawn {
	...
	class spawn_listbox : dorb_gui_listboxN {
		...
		onLBSelChanged = "_this spawn dorb_fnc_ui_spawn_select;";
		default = true;
	...
	class spawn_bttn_moveIn : dorb_gui_button {
		...
		onMouseEnter = "";
		onMouseExit = "";
		action = "[""driver""]call dorb_fnc_ui_spawn_create;";
	};
	class spawn_bttn_spawn : spawn_bttn_moveIn {
		...
		onSetFocus = "";
		action = "[]call dorb_fnc_ui_spawn_create;";
	};
};
...
class dorb_crate_alt {
	...
	class crate_spawn : dorb_gui_button {
		...
		colorShadow[] = UI_CL_BTN2;
		colorFocused[] = UI_CL_BTN2_foc;
		action = "[true]call dorb_fnc_ui_crate_spawn;false";
	};
...
class dorb_crate {
	...
	class crate_list_button_add : crate_spawn {
		...
		borderSize = 0;
		colorShadow[] = {0,0,0,0};
		action = "[true]call dorb_fnc_ui_crate_add;false";
	};
	class crate_list_button_sub : crate_list_button_add {
		idc = 1001;
		text = "-";
		action = "[false]call dorb_fnc_ui_crate_add;false";
	};
