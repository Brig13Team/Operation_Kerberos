class unitlists {
	...
	class east {
		...
		class vdv_mflora : vdv {
			...
			group_sf[] = {{"configfile","CfgGroups","East","rhs_faction_vdv","rhs_group_rus_vdv_infantry_flora","rhs_group_rus_vdv_infantry_mflora_section_marksman"},{"configfile","CfgGroups","East","rhs_faction_vdv","rhs_group_rus_vdv_infantry_flora","rhs_group_rus_vdv_infantry_mflora_squad_mg_sniper"},{"configfile","CfgGroups","East","rhs_faction_vdv","rhs_group_rus_vdv_infantry_flora","rhs_group_rus_vdv_infantry_mflora_squad_sniper"}};
		};
