...
R3F_LOG_CFG_language = switch (language) do
{
	...
	default {"de"}; // If language is not supported, use English
};
 ...
 */
R3F_LOG_CFG_string_condition_allow_creation_factory_on_this_client = "player getVariable [""DORB_INGENIEUR"",false] ";//"(vehicle player) in [""log1"",""log2"",""log3""]";//"true";
