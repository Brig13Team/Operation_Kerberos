...
DORB_HELPER_ID = [{
	...
	_pos = DORB_HELPER_VEH modelToWorld [0,(DORB_HELPER_SIZE select 1)/2,0];
	(DORB_HELPER_ARROW select 2) setPos _pos;
	_pos = DORB_HELPER_VEH modelToWorld [0,(-1*(DORB_HELPER_SIZE select 1))/2,0];
	(DORB_HELPER_ARROW select 3) setPos _pos;
	_pos = DORB_HELPER_VEH modelToWorld [(DORB_HELPER_SIZE select 0)/2,(DORB_HELPER_SIZE select 1)/2,(DORB_HELPER_SIZE select 2)/2];
	(DORB_HELPER_ARROW select 4) setPos _pos;
	_pos = DORB_HELPER_VEH modelToWorld [(-1*(DORB_HELPER_SIZE select 0))/2,(-1*(DORB_HELPER_SIZE select 1))/2,(-1*(DORB_HELPER_SIZE select 2))/2];
