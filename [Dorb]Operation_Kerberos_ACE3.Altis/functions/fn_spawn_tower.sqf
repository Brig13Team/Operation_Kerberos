...
_spawnposition = [(_this select 0),200,0] call dorb_fnc_random_pos;
...
d_log(FORMAT_1("Towerposistionen=%1",_gebauedepos))

[[_gebauedepos],20,30] FSPAWN(spawn_in_building);
_spawnposition FSPAWN(spawn_defence);
